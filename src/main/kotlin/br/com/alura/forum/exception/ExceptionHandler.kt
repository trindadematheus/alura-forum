...
import br.com.alura.forum.dto.FieldError
...
class ExceptionHandler {
    ...
    fun handleValidationError(
        ...
        var errorFields: List<FieldError> = ArrayList()

        exception.bindingResult.fieldErrors.forEach { e ->
            errorMessage.put(e.field, e.defaultMessage)
            errorFields = errorFields.plus(FieldError(field = e.field, error = e.defaultMessage))
        }
